...
### 重构
- 简化图标处理逻辑并使用Bitwarden图标服务

## [3.2.3] - 2026-04-10

### 修复
- 适配 OpenList v4.2.1 更新移除游客工具栏刷新按钮
...
### 优化
- 优化文件管理器搜索排序逻辑，确保搜索结果按匹配度排序
- 改进分组数据处理，使用 ??= 实现 inflight 缓存
- 修复搜索关键词清空时的排序问题
...
### 新增
- 添加服务工作者和入口脚本实现离线缓存和按钮替换功能

### 重构
- 优化入口文件结构并移除立即执行函数

### 构建
- 添加 posttauri 脚本清理临时文件
